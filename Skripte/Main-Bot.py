...
async def on_message(message):
    ...
    if message.content.startswith('//social'):
        await message.channel.send('YouTube: https://tinyurl.com/technikfreaksyt')
        await message.channel.send('TikTok: https://www.tiktok.com/@technikfreaksyt')
        await message.channel.send('Webseite: https://tinyurl.com/technikfreaks')

    if message.content.startswith('//help'):
        await message.channel.send('Support Kanal erstellen: "//support"')        
        await message.channel.send('Sprachkanal erstellen: "//voice" ACHTUNG: Du musst dem Channel selber joinen, ist der Channel leer, wird er nach 30 Sekunden gelöscht')        
        await message.channel.send('Alle meine Social Media Profile: " //social"')
